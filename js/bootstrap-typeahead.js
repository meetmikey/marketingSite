...
function ($) {
    ...
    var Typeahead = function (element, options) {
        ...
        this.next = this.options.next || this.source;
        this.prev = this.options.prev || this.source;        
    ...
    Typeahead.prototype = {
        ...
        select: function () {
            ...
            //JRD NOTE: I switched the order of the next two lines...
        ...
        keypress: function (e) {
            ...
            switch (e.keyCode) {
                //JRD HACK: dropping tab functionality so it works without selections
                //case 9:
                    // tab
                case 13:
                    // enter
